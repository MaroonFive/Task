...
<body>
<form id="form1" name="form1" method="post" action="../doenter.jsp" onsubmit="return yanzheng()">
<center>
  <table width="806" height="109" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      href="../jia.html"><img height="40" 
      src="../image/d_r3_c9.jpg" width="94" border="0" /></a><img height="40" 
      src="../image/top_red.jpg" width="20" border="0" /><a 
      href="../jsps/messageBoard.jsp"><img height="40" src="../image/d_r3_c10.jpg" width="94" 
    ...
    <tr>
      <td colspan="2" valign="top"><!-- TemplateBeginEditable name="EditRegion1" -->首页&gt;后台 管理 <!-- TemplateEndEditable --></td>
    </tr>
    <tr>
...
return true;
        ...
        <table width="382" height="128" border="1" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td colspan="2" align="center" bgcolor="#666666">管理员登陆</td>
            </tr>
          <tr>
            <td width="115" align="center" bgcolor="#CCCCCC">您的帐号：</td>
            <td width="261" bgcolor="#ebebeb"><input type="text" id="name" name="name"></td>
          </tr>
          <tr>
            <td align="center" bgcolor="#CCCCCC">您的密码：</td>
            <td bgcolor="#ebebeb"><input type="password" id="pass" name="pass"></td>
          </tr>
          <tr>
            <td colspan="2" align="center" bgcolor="#ebebeb"><input type="submit" value="登  陆">
          &nbsp;&nbsp;&nbsp;&nbsp;
