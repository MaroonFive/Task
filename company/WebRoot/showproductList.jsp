...
<form id="form1" name="form1" method="post" action="zhuyan.jsp">
  <table width="806" height="109" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td colspan="2" valign="top"><!-- TemplateBeginEditable name="EditRegion1" -->首页 &gt;商品展示 <!-- TemplateEndEditable --></td>
    </tr>
    <tr>
     ...
     request.setCharacterEncoding("GBK");
									String pageNum = request.getParameter("pageNum");//第几页
									int num = 0;
									if (pageNum == null) {
										num = 1;
									} else {
									...
									int allRows = ps.getCount();//总条数
									int allPage = (allRows + 5 - 1) / 5;//总页数
									num = num < 1 ? 1 : num;
									num = num > allPage ? allPage : num;
									List list = ps.getPageList(num);
								...
								<tr>
									<td>
										<a
											href="showproduct.jsp?productId=<%=product.getProductId()%>"><img border="0" 
                src="<%=product.getPicture() %>" /></a>
									</td>
									<td>
											...
											<tr>
												...
												<td width="280">
													<a style="color:blue; text-decoration: none;"
														href="showproduct.jsp?productId=<%=product.getProductId()%>"><%=product.getBrand()%>
													</a>
												</td>
											</tr>
											<tr>
								...
								<tr>
									<td colspan="2" align="right">
										<a href="showproductList.jsp?page=<%=(num - 1)%>">上一页</a>|
										<a href="showproductList.jsp?page=<%=(num + 1)%>">下一页</a>
									</td>
								</tr>
							</table>
      </center>
